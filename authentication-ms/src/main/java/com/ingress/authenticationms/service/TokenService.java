package com.ingress.authenticationms.service;

import com.ingress.authenticationms.cache.CacheUtil;
import com.ingress.authenticationms.exception.AuthException;
import com.ingress.authenticationms.model.client.UserClientResponse;
import com.ingress.authenticationms.model.response.TokenResponse;
import com.ingress.authenticationms.security.jwt.JwtUtil;
import com.ingress.authenticationms.security.model.AuthCacheData;
...
import static com.ingress.authenticationms.factory.TokenFactory.buildAccessTokenClaimsSet;
import static com.ingress.authenticationms.factory.TokenFactory.buildRefreshTokenClaimsSet;
import static com.ingress.authenticationms.model.constants.AuthConstants.AUTH_CACHE_DATA_PREFIX;
import static com.ingress.authenticationms.model.constants.AuthConstants.TOKEN_EXPIRE_DAY_COUNT;
import static com.ingress.authenticationms.model.constants.ExceptionConstants.REFRESH_TOKEN_COUNT_EXPIRED;
import static com.ingress.authenticationms.model.constants.ExceptionConstants.REFRESH_TOKEN_EXPIRED;
import static com.ingress.authenticationms.model.constants.ExceptionConstants.TOKEN_EXPIRED;
import static com.ingress.authenticationms.model.constants.ExceptionConstants.USER_UNAUTHORIZED;
